...
### Новое в версии
  ...
  - Реализация подсистемы профилей совместно с калькулятором расчета ректификации. #40
    Подробнее - [тут](https://ssvc0059.github.io/ssvc_open_connect/calculator/manual/) 
  - Добавлена поддержка пинов GPIO_11 и GPIO_12 в качестве исходящих пинов управления #56
  - Подробнее - [тут](https://ssvc0059.github.io/ssvc_open_connect/usage/interfaces/pin_out/)
