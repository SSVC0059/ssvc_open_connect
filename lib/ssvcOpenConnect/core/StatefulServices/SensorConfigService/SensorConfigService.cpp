...
bool SensorConfigService::setZoneForSensor(const std::string& addressStr, const SensorZone newZone) {
    ...
    const StateUpdateResult result = this->update([=](SensorConfigState& state) { // CAPTURE BY VALUE [=]
