# SSVC0059_V2 UART API Версия 1.9
...
- `formula=[0|1|2]` — формула. Значения `0` и `1` доступны начиная с API 1.7, значение `2` («авто 92+») — начиная с API 1.9.
...
```text
SET heads=[60.0,360],hearts=[2.0,4],hyst=0.19,decrement=30,formula=3
