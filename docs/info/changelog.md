...
**О формате:** для каждой версии указаны разделы «Новое в версии» / «Добавлено», «Изменено», «Исправлено», «Удалено». Версии перечислены от новых к старым. Ссылки на релизы и прошивки — на [странице релизов](https://github.com/SSVC0059/ssvc_open_connect/releases).
...
- Развёртывание [документации](https://ssvc0059.github.io/ssvc_open_connect/) на GitHub Pages
