...
### Исправлено
  ...
  - Исправлена прокрутка на мобильных устройствах в разделах настроек SSVC и OpenConnect [#129](https://github.com/SSVC0059/ssvc_open_connect/issues/129).
  - Исправлена некорректная загрузка содержимого профилей в веб-интерфейсе [#128](https://github.com/SSVC0059/ssvc_open_connect/issues/128).
...
### Документация
  ...
  - Обновлена документация по запуску и отладке тестов. Подробнее - [в документации](https://ssvc0059.github.io/ssvc_open_connect/develop/testing/).
...
### Новое в версии
  ...
  - При потери соединения UART светодиод WLED мигает желтым цветом. Отправляется уведомление в Telegram при потере связи  [#111](https://github.com/SSVC0059/ssvc_open_connect/issues/111).
  - **Core dump:** потоковая отдача больших дампов, очистка только после успешной передачи.
  - **Переход HTTP/WebSocket-стека** с встроенного PsychicHttp на [ESP32Async/ESPAsyncWebServer](https://github.com/ESP32Async/ESPAsyncWebServer)[#122](https://github.com/SSVC0059/ssvc_open_connect/pull/122).
  - В кодовой базе фреймворка заложена поддержка **Ethernet** (настройки и статус) для плат с проводным интерфейсом.


###  Исправление ошибок 

  - Исправление ошибки при работе с несколькими датчиками DS18b20 [#107](https://github.com/SSVC0059/ssvc_open_connect/pull/107)
  - Безопасная работа с синхронизацией без ручного разблокирования mutex [#108](https://github.com/SSVC0059/ssvc_open_connect/pull/108)
  - поддержка больших `chat_id` в Telegram (за пределами 32-битного int) [#109](https://github.com/SSVC0059/ssvc_open_connect/issues/109).
...
### Интерфейс и мастер настроек
  ...
  - **Мастер и оперативные настройки:** значение «время сброса» −1 блокирует небезопасный запуск ректификации [#75](https://github.com/SSVC0059/ssvc_open_connect/issues/75); в настройках скорости отбора исправлено сохранение параметров подголовников, тела и хвостов.
