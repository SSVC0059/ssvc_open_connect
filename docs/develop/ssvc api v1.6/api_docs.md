...
## Общий формат обмена
Запросы (Команды)
Запрос состоит из заглавных латинских букв, цифр и знака подчеркивания. Запрос должен заканчиваться символом \n или \r.
...
Переключает на следующий этап ректификации. Команда аналогична нажатию кнопки Далее/Выход на этапах Головы / Тело / Хвосты.
Доступна только в процессе ректификации. На последнем этапе завершает ректификацию и выводит SSVC в дежурный режим
