...
| `native/test_uart_api_spec` | SsvcUartApiSpec — лимиты и валидация по UART API v1.10 |
| `native/test_ssvc_log_protocol` | GET_LOG: LIST/START/file, base64, ошибки `err_*`, таймаут передачи |
