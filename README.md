...
Проект очень сильно нуждается в человеке, который сможет заняться фронтендом. Проект использует SvelteKit, так как он наиболее оптимальный в плане работы на ESP32 с возможностями реактивного интерфейса.
