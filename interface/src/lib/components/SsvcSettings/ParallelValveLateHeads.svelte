...
<style>
	.settings-table {
		@apply w-full border-collapse border border-gray-700 dark:border-gray-600;
	}
	.settings-table th,
	.settings-table td {
